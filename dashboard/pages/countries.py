...
#from dashboard.caching import cleaned_data
...
#
#df_path = str(Path(__file__).resolve().parents[2] / "data" / "processed" / "combined_benchmarks_cleaned.csv")
#
#
#def layout():
#    df = cleaned_data()
...
#        html.P(
#            """Country wise analysis of ai capabilities.
#        """
#        ),
#        dbc.Row(
#            dbc.Col(
#                dcc.Dropdown(
#                    sorted(unique_countries(df)), value="United States of America", clearable=False, id="country-dropdown-selection"
#                ),
#                md=3,
#                sm=12,
#            ),
